...
(function () {
  ...
  reactHotLoader.register(LoginBtn, 'LoginBtn', 'src/pages/AuthPage/pages/SignInPage/components/LoginBtn.js');
  reactHotLoader.register(_default, 'default', 'src/pages/AuthPage/pages/SignInPage/components/LoginBtn.js');
  leaveModule(module);
})();
