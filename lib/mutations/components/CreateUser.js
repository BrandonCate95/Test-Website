...
var _CREATE_USER = require('../mutation/CREATE_USER');
...
var CreateUser = function CreateUser(props) {
    return _react2.default.createElement(
        ...
        { mutation: _CREATE_USER2.default },
        function (createUser, _ref) {
            var loading = _ref.loading,
                error = _ref.error,
                data = _ref.data;
            return _react2.default.cloneElement(props.children, { loading: loading, error: error, data: data, createUserMutation: function () {
...
(function () {
    ...
    reactHotLoader.register(CreateUser, 'CreateUser', 'src/mutations/components/CreateUser.js');
    reactHotLoader.register(_default, 'default', 'src/mutations/components/CreateUser.js');
    leaveModule(module);
})();
