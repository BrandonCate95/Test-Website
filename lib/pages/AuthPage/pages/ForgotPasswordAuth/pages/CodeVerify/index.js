                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _lib2.default.forgotPasswordSubmit(_this.props.location.state.username, _this.state.code, _this.state.password).then(function () {
                                    _this.setState({ loading: false, redirectToReferrer: true });
                                }).catch(function (err) {
...
(function () {
    ...
    reactHotLoader.register(StyledDiv, 'StyledDiv', 'src/pages/AuthPage/pages/ForgotPasswordAuth/pages/CodeVerify/index.js');
    reactHotLoader.register(CodeVerify, 'CodeVerify', 'src/pages/AuthPage/pages/ForgotPasswordAuth/pages/CodeVerify/index.js');
    reactHotLoader.register(_default, 'default', 'src/pages/AuthPage/pages/ForgotPasswordAuth/pages/CodeVerify/index.js');
    leaveModule(module);
})();
