...
var UserPageDrafts = function UserPageDrafts(_ref) {
    var data = _ref.data,
        logoImg = _ref.logoImg,
        username = _ref.username,
        identityId = _ref.identityId,
        draftEdit = _ref.draftEdit;
    return data.listUserDrafts.drafts.map(function (post) {
...
(function () {
    ...
    reactHotLoader.register(Loading, 'Loading', 'src/pages/UserPage/components/UserPageDrafts.js');
    reactHotLoader.register(VerticalCard, 'VerticalCard', 'src/pages/UserPage/components/UserPageDrafts.js');
    reactHotLoader.register(UserPageDrafts, 'UserPageDrafts', 'src/pages/UserPage/components/UserPageDrafts.js');
    reactHotLoader.register(_default, 'default', 'src/pages/UserPage/components/UserPageDrafts.js');
    leaveModule(module);
})();
