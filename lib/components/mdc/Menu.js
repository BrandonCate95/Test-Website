...
var _templateObject = _taggedTemplateLiteral(['left:', ' !important;'], ['left:', ' !important;']);
...
var StyledMenuDiv = /*#__PURE__*/_styledComponents2.default.div.withConfig({
    componentId: 'sc-1xut3oy-0'
...
var MenuContainer = function (_React$Component) {
    ...
    function MenuContainer() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = MenuContainer.__proto__ || Object.getPrototypeOf(MenuContainer)).call.apply(_ref2, [this].concat(args))), _this), _this.menu = null, _this.menuEl = _react2.default.createRef(), _this.menuButtonEl = _react2.default.createRef(), _this.componentDidMount = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
            var _ref4, MDCMenu, Corner;
                    ...
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            return Promise.resolve().then(function () {
                                return _interopRequireWildcard(require('@material/menu'));
                            });

                        case 2:
                            _ref4 = _context.sent;
                            MDCMenu = _ref4.MDCMenu;
                            Corner = _ref4.Corner;

                            // Instantiation
                            _this.menu = new MDCMenu(_this.menuEl.current);
                            // Toggle menu open
                            ...
                            _this.menu.setAnchorCorner(Corner.BOTTOM_START);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        StyledMenuDiv,
                        { innerRef: this.menuEl, className: 'mdc-menu', tabIndex: '-1', left: menu.props.offset },
                        menu
                    )
                )
            );
...
(function () {
    ...
    reactHotLoader.register(StyledMenuDiv, 'StyledMenuDiv', 'src/components/mdc/Menu.js');
    reactHotLoader.register(Menu, 'Menu', 'src/components/mdc/Menu.js');
    reactHotLoader.register(MenuContainer, 'MenuContainer', 'src/components/mdc/Menu.js');
    reactHotLoader.register(_default, 'default', 'src/components/mdc/Menu.js');
    leaveModule(module);
})();
